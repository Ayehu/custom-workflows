...
<ul>
  ...
  <li>On the child workflow, your Duo APIs specified endpoint URL, as well as integration key and secret key must be set in the first three MemorySet activities ("setAPI", "setIntegrationKey", "setSecretKey").
